...
// ─── Logger ───────────────────────────────────────────────────────────────────
function log(...args) { console.log('[God]', ...args); }
...
async function handleAccept(username) {
  ...
  if (!req || Date.now() > req.expires) { tpRequests.delete(username); return; }
...
// ─── Boot ─────────────────────────────────────────────────────────────────────
log(`=== God bot starting | ${HOST}:${MC_PORT} | base: ${BASE_X},${BASE_Y},${BASE_Z} ===`);
createBot();
